...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 199.99,
    description:
      'Bose SoundLink Bluetooth speaker III Share the music. Show your style. Meet the speaker that brings your music and friends together with a style that is all your own',
    image: 'https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg',
  },
  {
    id: 8,
  ...
  {
    id: 9,
    name: 'Samsung Galaxy S21 Ultra 5G | Factory Unlocked Android Cell Phone',
    price: 1199.99,
    description:
